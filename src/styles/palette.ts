...
export const gradients = {
	...
	dark: {
		cardSurface: 'linear-gradient(180deg, rgba(36, 36, 36, 0.96) 0%, rgba(18, 18, 18, 0.98) 100%)',
		descriptionSurface:
			'linear-gradient(180deg, rgba(35, 35, 35, 0.88) 0%, rgba(20, 20, 20, 0.72) 100%)',
		fieldSurface: 'linear-gradient(180deg, rgba(44, 44, 44, 0.92) 0%, rgba(26, 26, 26, 0.94) 100%)',
		...
		stepperButton:
			'linear-gradient(180deg, rgba(50, 50, 50, 0.96) 0%, rgba(20, 20, 20, 0.98) 48%, rgba(16, 16, 16, 0.98) 52%, rgba(50, 50, 50, 0.96) 100%)',
		stepperControl:
